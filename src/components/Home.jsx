...
import Source from './assets/LU_Logo-JPG_100220.jpg'
      ...
      <div className="firstsection">
        ...
        <div className="maincontainer">
          <h1 className="mainheading">
            Lucknow University Placement Management System
          </h1>
          <div className="maincontent">
            At Lucnow University, we are dedicated to fostering your professional growth and connecting you with rewarding
